        ...
        <div className="glass rounded-3xl p-8 shadow-md">
          {error && (
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
              className="mb-6 p-4 bg-red-50 border border-red-200 text-red-600 rounded-xl text-sm flex items-start gap-2 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest mb-2">Nama Panggilan</label>
              <input
            ...
            <div>
              <label className="block text-xs font-bold text-stone-500 uppercase tracking-widest mb-2">Nomor Absen</label>
              <input
          ...
          <button onClick={() => navigate('/')} className="mt-8 w-full text-center text-sm text-stone-400 hover:text-sky-500 transition font-bold">
